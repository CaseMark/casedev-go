...
func TestAgentV2ExecuteNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Agent.V2.Execute.New(context.TODO(), githubcomcasemarkcasedevgo.AgentV2ExecuteNewParams{
		...
		Sandbox: githubcomcasemarkcasedevgo.F(githubcomcasemarkcasedevgo.AgentV2ExecuteNewParamsSandbox{
