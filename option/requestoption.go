...
// RequestOption is an option for the requests made by the casedev API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/CaseMark/casedev-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://api.case.dev/")
}
...
func WithEnvironmentLocal() RequestOption {
	return requestconfig.WithDefaultBaseURL("http://localhost:2728/")
}
