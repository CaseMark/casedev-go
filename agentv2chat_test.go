...
func TestAgentV2ChatNewWithOptionalParams(t *testing.T) {
...
func TestAgentV2ChatDelete(t *testing.T) {
	...
	_, err := client.Agent.V2.Chat.Delete(context.TODO(), "id")
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestAgentV2ChatCancel(t *testing.T) {
	...
	_, err := client.Agent.V2.Chat.Cancel(context.TODO(), "id")
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestAgentV2ChatNewStreamToken(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Agent.V2.Chat.NewStreamToken(context.TODO(), "id")
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestAgentV2ChatReplyToQuestion(t *testing.T) {
	...
	err := client.Agent.V2.Chat.ReplyToQuestion(
		context.TODO(),
		"id",
		"requestID",
		githubcomcasemarkcasedevgo.AgentV2ChatReplyToQuestionParams{
...
func TestAgentV2ChatSendMessageWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Agent.V2.Chat.SendMessage(
		context.TODO(),
		"id",
