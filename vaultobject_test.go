...
func TestVaultObjectUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vault.Objects.Update(
		...
		"id",
		"objectId",
		githubcomcasemarkcasedevgo.VaultObjectUpdateParams{
			Filename: githubcomcasemarkcasedevgo.F("deposition-smith-2024.pdf"),
			Metadata: githubcomcasemarkcasedevgo.F[any](map[string]interface{}{}),
			Path:     githubcomcasemarkcasedevgo.F("/Discovery/Depositions"),
		},
	)
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
...
func TestVaultObjectNewPresignedURLWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vault.Objects.NewPresignedURL(
		...
		"id",
		"objectId",
		githubcomcasemarkcasedevgo.VaultObjectNewPresignedURLParams{
			ContentType: githubcomcasemarkcasedevgo.F("contentType"),
			ExpiresIn:   githubcomcasemarkcasedevgo.F(int64(60)),
			Operation:   githubcomcasemarkcasedevgo.F(githubcomcasemarkcasedevgo.VaultObjectNewPresignedURLParamsOperationGet),
...
func TestVaultObjectDownload(t *testing.T) {
	...
	resp, err := client.Vault.Objects.Download(
		context.TODO(),
		"id",
		"objectId",
	)
...
func TestVaultObjectGetChunksWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Vault.Objects.GetChunks(
		...
		"id",
		"objectId",
		githubcomcasemarkcasedevgo.VaultObjectGetChunksParams{
			End:   githubcomcasemarkcasedevgo.F(int64(0)),
			Start: githubcomcasemarkcasedevgo.F(int64(0)),
		},
	)
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
...
func TestVaultObjectGetOcrWordsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Vault.Objects.GetOcrWords(
		...
		"id",
		"objectId",
		githubcomcasemarkcasedevgo.VaultObjectGetOcrWordsParams{
			Page:      githubcomcasemarkcasedevgo.F(int64(0)),
			WordEnd:   githubcomcasemarkcasedevgo.F(int64(0)),
			WordStart: githubcomcasemarkcasedevgo.F(int64(0)),
		},
	)
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
...
func TestVaultObjectGetPagesWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Vault.Objects.GetPages(
		...
		"id",
		"objectId",
		githubcomcasemarkcasedevgo.VaultObjectGetPagesParams{
			End:   githubcomcasemarkcasedevgo.F(int64(0)),
			Start: githubcomcasemarkcasedevgo.F(int64(0)),
		},
	)
