...
func TestAgentV2RunNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Agent.V2.Run.New(context.TODO(), githubcomcasemarkcasedevgo.AgentV2RunNewParams{
...
func TestAgentV2RunExec(t *testing.T) {
	...
	_, err := client.Agent.V2.Run.Exec(context.TODO(), "id")
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestAgentV2RunGetDetails(t *testing.T) {
	...
	_, err := client.Agent.V2.Run.GetDetails(context.TODO(), "id")
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestAgentV2RunGetStatus(t *testing.T) {
	...
	_, err := client.Agent.V2.Run.GetStatus(context.TODO(), "id")
	if err != nil {
		var apierr *githubcomcasemarkcasedevgo.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
