...
import (
	...
	"github.com/CaseMark/casedev-go/internal"
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Vault.New(context.Background(), githubcomcasemarkcasedevgo.VaultNewParams{
		Name: githubcomcasemarkcasedevgo.F("My Vault"),
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Vault.New(cancelCtx, githubcomcasemarkcasedevgo.VaultNewParams{
		Name: githubcomcasemarkcasedevgo.F("My Vault"),
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Vault.New(deadlineCtx, githubcomcasemarkcasedevgo.VaultNewParams{
			Name: githubcomcasemarkcasedevgo.F("My Vault"),
		})
		if err == nil {
