...
<a href="https://pkg.go.dev/github.com/CaseMark/casedev-go"><img src="https://pkg.go.dev/badge/github.com/CaseMark/casedev-go.svg" alt="Go Reference"></a>

The Casedev Go library provides convenient access to the [Casedev REST API](https://docs.case.dev)
...
```sh
go get -u 'github.com/CaseMark/casedev-go@v0.17.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/CaseMark/casedev-go/option).
...
`*githubcomcasemarkcasedevgo.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `githubcomcasemarkcasedevgo.FileParam(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/CaseMark/casedev-go/issues) with questions, bugs, or suggestions.
